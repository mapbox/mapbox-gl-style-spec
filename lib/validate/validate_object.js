...
module.exports = function validateObject(options) {
    ...
    for (var objectKey in object) {
        ...
        if (objectElementSpec || objectElementValidator) {
            ...
            var message = 'unknown property "%s"';
            if (objectKey === 'interactive') message += '; the "interactive" key is deprecated';
            errors.push(new ValidationError(key, object[objectKey], message, objectKey));
        }
    }
