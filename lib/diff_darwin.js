...
let operations = {
    addLayer: function (layer, beforeLayerId, os) {
        ...
        let refLayerId;
        let refLayerVar;
        if (layerClass !== 'MGLBackgroundStyleLayer' && !sourceId && 'ref' in layer) {
        ...
        if (refLayerId) {
            ...
            statements.unshift(VariableDeclaration('MGLForegroundStyleLayer', refLayerVar,
                                                   TypeCoercion('MGLForegroundStyleLayer', getRefLayerMsg)));
        }
