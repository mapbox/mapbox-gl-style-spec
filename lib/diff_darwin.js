...
TypeCoercion.prototype.toString = function () {
    return `(${this.coercedType} *)${this.val}`;
};
...
VariableDeclaration.prototype.toString = function () {
    return ' '.repeat(this.indentation * tabWidth) + `${this.dataType} *${this.name} = ${this.value};`;
};
...
Assignment.prototype.toString = function () {
    return ' '.repeat(this.indentation * tabWidth) + (this.variable ? `${this.variable} = ${this.value}` : this.value.toString()) + ';';
};
